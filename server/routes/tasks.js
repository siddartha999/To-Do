...
const { createNewTask, retrieveCurrentTasks, deleteCurrentTask, 
    toggleCurrentCompletedTasks, retrieveCompletedTasks, deleteCompletedTask, retrieveUserStats } = require('../controllers/tasks');
...
//Retrieve Stats w.r.t the current user.
router.get('/stats', auth, retrieveUserStats);
